...
module.exports.run = async (client, player, track) => {
    ...
    const Started = new EmbedBuilder()
        ...
        .addFields([
            ...
            { name: `Requested:`, value: `${track.info.requester}`, inline: true },
        ])
    ...
    const bInfo = new ButtonBuilder().setCustomId("info").setEmoji(emoji.info).setStyle(ButtonStyle.Success);
        ...
        if (message.customId === "loop") {
            ...
            if (!player) {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .addFields([
                        { name: `Artist:`, value: `${currentAuthor}`, inline: true },
                        { name: `Requested:`, value: `${player.currentTrack.info.requester}`, inline: true },
